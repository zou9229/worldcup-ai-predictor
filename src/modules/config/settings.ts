...
export function getSettingGroups(): SettingGroup[] {
  return [
    ...
    { name: 'gemini_vertex', title: 'Vertex AI Gemini', description: 'Google Vertex AI Gemini API', tab: 'ai' },
...
export function getSettings(): Setting[] {
  return [
    ...
    // Vertex AI Gemini
    { name: 'gemini_vertex_project_id', title: 'Project ID', type: 'text', placeholder: 'my-gcp-project', tip: 'Optional when project_id exists in the service account JSON', group: 'gemini_vertex', tab: 'ai' },
    { name: 'gemini_vertex_location', title: 'Location', type: 'text', placeholder: 'us-central1', group: 'gemini_vertex', tab: 'ai', defaultValue: 'us-central1' },
    { name: 'gemini_vertex_model', title: 'Default Model', type: 'text', placeholder: 'gemini-2.5-flash', group: 'gemini_vertex', tab: 'ai', defaultValue: 'gemini-2.5-flash' },
    { name: 'gemini_vertex_fallback_models', title: 'Fallback Models', type: 'textarea', placeholder: 'gemini-2.5-flash-lite\ngemini-2.0-flash', tip: 'Optional fallback models, one per line or comma-separated', group: 'gemini_vertex', tab: 'ai' },
    { name: 'gemini_vertex_service_account_json', title: 'Service Account JSON', type: 'textarea', placeholder: '{ "type": "service_account", ... }', tip: 'Google Cloud service account JSON with Vertex AI access. Stored encrypted when CONFIG_ENCRYPTION_KEY is set.', group: 'gemini_vertex', tab: 'ai' },
